...
test("the series-page fallback ignores other series' chapter links", () => {
  const result = parseNatoSeriesPage(
    `<div class="chapter-list">
       <a href="/manga/other-series/chapter-900">Chapter 900</a>
       <a href="/manga/blue-lock/chapter-351">Chapter 351</a>
     </div>`,
    "https://www.natomanga.com/manga/blue-lock",
    { timestamp: TIMESTAMP }
  );
...
test("a Latest link to another series doesn't become the latest chapter", () => {
  const result = parse(
    page(`
      <a class="bm-title" href="/manga/blue-lock">Blue Lock</a>
      <span>Latest: <a href="/manga/other-series/chapter-900">Chapter 900</a></span>
      <span>Viewed: <a href="/manga/blue-lock/chapter-12">Chapter 12</a></span>
    `)
  );
  assert.equal(result.records[0].chapter, "12");
